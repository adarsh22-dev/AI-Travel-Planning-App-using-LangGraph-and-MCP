...
# PDF uses built-in Helvetica font — no external font download needed
...
/* ── Hero ── */
.hero-wrap{{position:relative;width:100vw;left:50%;transform:translateX(-50%);border-radius:0;overflow:hidden;margin-bottom:1.5rem;min-height:clamp(180px,45vh,600px);background-size:auto,cover;background-position:center;background-repeat:no-repeat}}
